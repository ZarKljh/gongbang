...
export default function SellerSignupPage() {
    ...
    return (
        <section>
            <h3>셀러 회원가입페이지</h3>
            {step === 1 && <UserForm userInfo={userInfo} setUserInfo={setUserInfo} onNext={handleNext} />}
            {step === 2 && <StudioForm studioInfo={studioInfo} setStudioInfo={setStudioInfo} onSubmit={handleSubmit} />}
        </section>
    )
}
